...
| `["items", "with-details", storeId]`        | create/update/merge/get-or-create/delete item, toggle favorite, update/delete aisle, update/delete/move section, upsert list item, move-item-to-store (target), auto-categorize, **add-recipe-to-list** (`["items"]`\*)                                                                                                   |
...
| `["shopping-list-items", storeId]`          | upsert/toggle/delete/remove/clear/move list item, update/delete aisle, update/delete/move/reorder section, reorder aisle, **`useUpdateItem`**, **`useMergeItems`**, **`useDeleteItem`**, `useDeleteOrphanItems` (defensive), bulk import, auto-categorize, **`useAddRecipeToShoppingList`** (`["shopping-list-items"]`\*) |
