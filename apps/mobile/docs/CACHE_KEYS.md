...
| `["shopping-list-items", storeId]`          | upsert/toggle/delete/remove/clear/move list item, update/delete aisle, update/delete/move/reorder section, reorder aisle, **`useUpdateItem`**, **`useMergeItems`**, **`useDeleteItem`**, bulk import, auto-categorize, **`useAddRecipeToShoppingList`** (`["shopping-list-items"]`\*) |
