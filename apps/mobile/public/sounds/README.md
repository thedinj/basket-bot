...
- `explosion.mp3` - Nuclear detonation effect for obliterating unused store items
...
Sound files are referenced in the animation effects library (`src/animations/effects.ts`) with paths like `/sounds/filename.mp3`.
